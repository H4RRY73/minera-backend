package com.platform.ventistorebackend.iam.infrastructure.authorization.sfs.configuration;

import com.platform.ventistorebackend.iam.infrastructure.authorization.sfs.pipeline.BearerAuthorizationRequestFilter;
import com.platform.ventistorebackend.iam.infrastructure.hashing.bcrypt.BCryptHashingService;
import com.platform.ventistorebackend.iam.infrastructure.tokens.jwt.BearerTokenService;
...
public class WebSecurityConfiguration {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("https://maintenance-dev-43f4b.web.app/")); // Permitir Angular
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                .cors(Customizer.withDefaults()) // <--- HABILITA CORS EN SEGURIDAD
